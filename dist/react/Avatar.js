...
function Avatar(props) {
    ...
    const fontColor = bgColor == 'base-content' ? 'text-base-0' : _optionalChain([bgColor, 'optionalAccess', _ => _.startsWith, 'call', _2 => _2('base')]) ? 'text-base-content' : `text-${bgColor}-content`;
    ...
    const formattedInitials = _optionalChain([initials, 'optionalAccess', _3 => _3.length]) > 1 ? _optionalChain([initials, 'optionalAccess', _4 => _4.slice, 'call', _5 => _5(0, 1)]) : initials;
