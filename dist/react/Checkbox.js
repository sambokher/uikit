...
onClick: onCheckboxChange,}
            ...
            , React.createElement('div', { className: "relative flex-shrink-0 inline-block"  ,}
                , React.createElement('span', { className: checkboxClasses,}
                    , checked ? !isPartial ? 
                        React.createElement('svg', { className: "w-5 h-5" , viewBox: "0 0 20 20"   , 'aria-hidden': "true", fill: `var(--${checkColor})`,}
                            , React.createElement('path', { fillRule: "evenodd", d: "M6.293 9.293a1 1 0 011.414 0L10 11.586l2.293-2.293a1 1 0 111.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z"                  , clipRule: "evenodd",} )
                        ) :
                        React.createElement('svg', { className: "w-5 h-5" , viewBox: "0 0 20 20"   , 'aria-hidden': "true", fill: `var(--${checkColor})`,}
                            , React.createElement('rect', { x: "4", y: "9", width: "12", height: "2",} )
                        )
                        : null
                    
                )
            )
            , label && React.createElement('span', { className: labelClasses, style: {textWrap: 'nowrap'},}
, label
            )
        )
    );
