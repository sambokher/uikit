...
function Form(props) {
    ...
    const autoFontStyle = (!background || background == 'none') ? 'text-inherit' : background == 'base-900' ? `text-base-0` : _optionalChain([background, 'optionalAccess', _2 => _2.startsWith, 'call', _3 => _3('base')]) ? 'text-base-content' : `text-${background}-content`;
