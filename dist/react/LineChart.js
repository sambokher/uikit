...
, title
            ...
            React.createElement('div', { className: "flex flex-row" , style: { 
                ...
                , React.createElement(LineChart, { data: sampleData, margin: { top: 20, right: sideMargins, bottom: 0, left: sideMargins },}
                    ...
                    , showLabels && React.createElement(LabelList, { dataKey: _optionalChain([data, 'optionalAccess', _9 => _9.keyPairs, 'access', _10 => _10[1]]), position: "top", style: { fill: `var(--${lineColor})`, fontSize: 10 },} )
                    )
                )
            )
            )
