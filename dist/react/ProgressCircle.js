...
function ProgressCircle(props) {
    ...
    return (
        ...
        ...attributes, ...listeners, 
         ...
         , React.createElement('div', { style: { position: 'relative', width: radius * 2, height: radius * 2 },}
            , React.createElement('svg', { height: radius * 2, width: radius * 2, style: { transform: 'rotate(-90deg)' },}
            ...
            /* LABELING */
            , React.createElement('div', { className: `flex flex-col items-center justify-center max-w-full gap-1 leading-tight font-semibold absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2`,}
                , radius >= 60 && !noLabel ? 
                React.createElement('h3', { className: `whitespace-nowrap text-center font-normal ${labelFontSizeMap[circleRadius]}`, style: { maxWidth: radius * 1.2 },}
, label
                    ) 
                : null
        ...
        , radius < 60 && !noLabel ? React.createElement('h3', { className: `whitespace-nowrap font-normal ${labelFontSizeMap[circleRadius]}`,}
, label
                )
        : null
        )
