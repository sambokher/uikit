...
function Sidebar(props) {
    ...
    const fontColor = (background == 'none' || !background) ? '' : (background == 'base-900' || background == 'base-700' || background == 'base-content') ? `text-base-0` : _optionalChain([background, 'optionalAccess', _ => _.startsWith, 'call', _2 => _2('base')]) ? 'text-base-content' : `text-${background}-content`;
