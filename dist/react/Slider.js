...
onChange: handleSliderChange,
        ...
        , React.createElement('div', { className: "justify-between flex flex-row w-full text-sm"    ,}
                , React.createElement('div', { className: "flex-shrink-0 leading-none" ,}, minValue)
                , React.createElement('div', { className: "flex-shrink-0 leading-none" ,}, maxValue)
            )
        )
    ); 
}
