...
onClick: () => setIsToggled(!isToggled),}
            ...
            , React.createElement('div', { className: switchClasses,}
                , React.createElement('div', { className: toggleSpanStyle,
                style: {
            ...
            , label && React.createElement('span', { className: labelClasses, style: {textWrap: 'balance'},}
, label
            )
        )
    );
